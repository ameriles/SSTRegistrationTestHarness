...
// Type: WebService_Tester.ServiceReference1.AddressType
...
namespace WebService_Tester.ServiceReference1
{
  ...
  public class AddressType : INotifyPropertyChanged
  {
    ...
    [XmlElement("USAddress", typeof (AddressTypeUSAddress), Order = 0)]
    [XmlElement("ForeignAddress", typeof (AddressTypeForeignAddress), Order = 0)]
    public object Item
    {
      get
      {
