...
namespace SstRegistrationTestHarness.Core.SstRegistrationService {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://SST", ConfigurationName = "SstRegistrationService.IApiService")]
    public interface IApiService
    {
        ...
        SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationAcknowledgementType BulkRegistration(SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationTransmissionType bulkRegistrationTransmission);

        [System.ServiceModel.OperationContractAttribute(Action = "http://SST/IApiService/BulkRegistration", ReplyAction = "http://SST/IApiService/BulkRegistrationResponse")]
        System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationAcknowledgementType> BulkRegistrationAsync(SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationTransmissionType bulkRegistrationTransmission);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType GetDocuments(string AcknowledgementStatus);

        [System.ServiceModel.OperationContractAttribute(Action = "http://SST/IApiService/GetDocuments", ReplyAction = "http://SST/IApiService/GetDocumentsResponse")]
        System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType> GetDocumentsAsync(string AcknowledgementStatus);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType GetTransmission(string TransmissionId);

        [System.ServiceModel.OperationContractAttribute(Action = "http://SST/IApiService/GetTransmission", ReplyAction = "http://SST/IApiService/GetTransmissionResponse")]
        System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType> GetTransmissionAsync(string TransmissionId);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        SstRegistrationTestHarness.Core.SstRegistrationService.SSTReceiptType AcknowledgeTransmission(SstRegistrationTestHarness.Core.SstRegistrationService.SSTPAcknowledgementType acknowledgement);

        [System.ServiceModel.OperationContractAttribute(Action = "http://SST/IApiService/AcknowledgeTransmission", ReplyAction = "http://SST/IApiService/AcknowledgeTransmissionResponse")]
        System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTReceiptType> AcknowledgeTransmissionAsync(SstRegistrationTestHarness.Core.SstRegistrationService.SSTPAcknowledgementType acknowledgement);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IApiServiceChannel : SstRegistrationTestHarness.Core.SstRegistrationService.IApiService, System.ServiceModel.IClientChannel
    {
    }

    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ApiServiceClient : System.ServiceModel.ClientBase<SstRegistrationTestHarness.Core.SstRegistrationService.IApiService>, SstRegistrationTestHarness.Core.SstRegistrationService.IApiService
    {
        ...
        public SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationAcknowledgementType BulkRegistration(SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationTransmissionType bulkRegistrationTransmission)
        {
            return base.Channel.BulkRegistration(bulkRegistrationTransmission);
        }

        public System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationAcknowledgementType> BulkRegistrationAsync(SstRegistrationTestHarness.Core.SstRegistrationService.BulkRegistrationTransmissionType bulkRegistrationTransmission)
        {
            return base.Channel.BulkRegistrationAsync(bulkRegistrationTransmission);
        }

        public SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType GetDocuments(string AcknowledgementStatus)
        {
            return base.Channel.GetDocuments(AcknowledgementStatus);
        }

        public System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType> GetDocumentsAsync(string AcknowledgementStatus)
        {
            return base.Channel.GetDocumentsAsync(AcknowledgementStatus);
        }

        public SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType GetTransmission(string TransmissionId)
        {
            return base.Channel.GetTransmission(TransmissionId);
        }

        public System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTRegistrationTransmissionType> GetTransmissionAsync(string TransmissionId)
        {
            return base.Channel.GetTransmissionAsync(TransmissionId);
        }

        public SstRegistrationTestHarness.Core.SstRegistrationService.SSTReceiptType AcknowledgeTransmission(SstRegistrationTestHarness.Core.SstRegistrationService.SSTPAcknowledgementType acknowledgement)
        {
            return base.Channel.AcknowledgeTransmission(acknowledgement);
        }

        public System.Threading.Tasks.Task<SstRegistrationTestHarness.Core.SstRegistrationService.SSTReceiptType> AcknowledgeTransmissionAsync(SstRegistrationTestHarness.Core.SstRegistrationService.SSTPAcknowledgementType acknowledgement)
        {
